...
pub async fn trace_start(
	client: &CdpClient, session_id: &str, tracing_state: &mut TracingState,
) -> Result<Value, String> {
...
pub async fn trace_stop(
	client: &CdpClient, session_id: &str, tracing_state: &mut TracingState, path: Option<&str>,
) -> Result<Value, String> {
	if !tracing_state.active {
...
pub async fn profiler_start(
	client: &CdpClient, session_id: &str, tracing_state: &mut TracingState, categories: Option<Vec<String>>,
) -> Result<Value, String> {
	if tracing_state.active {
