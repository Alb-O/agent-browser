use {
	super::cdp::{client::CdpClient, types::EvaluateParams},
	serde_json::{Value, json},
};

pub async fn storage_get(
	client: &CdpClient, session_id: &str, storage_type: &str, key: Option<&str>,
) -> Result<Value, String> {
...
pub async fn storage_set(
	client: &CdpClient, session_id: &str, storage_type: &str, key: &str, value: &str,
) -> Result<(), String> {
	let st = storage_js_name(storage_type);
	let js = format!(
		"{}.setItem({}, {})",
