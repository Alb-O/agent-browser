...
pub async fn set_extra_headers(
	client: &CdpClient, session_id: &str, headers: &HashMap<String, String>,
) -> Result<(), String> {
...
pub async fn install_domain_filter_script(
	client: &CdpClient, session_id: &str, allowed_domains: &[String],
) -> Result<(), String> {
...
pub async fn install_domain_filter_fetch(client: &CdpClient, session_id: &str) -> Result<(), String> {
	client
		.send_command(
			"Fetch.enable",
			Some(json!({
