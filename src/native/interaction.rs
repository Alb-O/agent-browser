use {
	super::{
		cdp::{client::CdpClient, types::*},
		element::{RefMap, resolve_element_center, resolve_element_object_id},
	},
	serde_json::Value,
};

pub async fn click(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: &str, button: &str, click_count: i32,
) -> Result<(), String> {
...
pub async fn dblclick(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: &str,
) -> Result<(), String> {
...
pub async fn fill(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: &str, value: &str,
) -> Result<(), String> {
...
pub async fn type_text(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: &str, text: &str, clear: bool,
	delay_ms: Option<u64>,
) -> Result<(), String> {
	let object_id = resolve_element_object_id(client, session_id, ref_map, selector_or_ref).await?;
...
pub async fn press_key_with_modifiers(
	client: &CdpClient, session_id: &str, key: &str, modifiers: Option<i32>,
) -> Result<(), String> {
...
pub async fn scroll(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: Option<&str>, delta_x: f64, delta_y: f64,
) -> Result<(), String> {
...
pub async fn select_option(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: &str, values: &[String],
) -> Result<(), String> {
	let object_id = resolve_element_object_id(client, session_id, ref_map, selector_or_ref).await?;
...
pub async fn check(
	...
	let is_checked = super::element::is_element_checked(client, session_id, ref_map, selector_or_ref).await?;
	if !is_checked {
...
pub async fn dispatch_event(
	client: &CdpClient, session_id: &str, ref_map: &RefMap, selector_or_ref: &str, event_type: &str,
...
async fn dispatch_click(
	client: &CdpClient, session_id: &str, x: f64, y: f64, button: &str, click_count: i32,
) -> Result<(), String> {
	// Move
	client
		.send_command_typed::<_, Value>(
